...
/**
 * Class BankIntegrationSqlTest
 */
class BankSqlIntegrationTest extends AbstractSqlIntegrationTest
{
    ...
    {
        $this->initBdd();
        $actual = $this->query('bank.getById', array(':id' => 1));
    ...
    {
        $this->initBdd();
        $actual = $this->query('bank.listAll');
        $this->assertEqualsResultSet($actual);
    }
}
